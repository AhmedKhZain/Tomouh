...
/// <summary>
/// Base class for clean, non-auditable Aggregate Roots in Domain-Driven Design (DDD).
/// Inherits directly from <see cref="BaseEntity{TId}"/> to bypass automatic audit tracking and timestamps.
/// Manages domain and integration events collection.
/// </summary>
/// <typeparam name="TId">The type of the entity's unique identifier.</typeparam>
public abstract class AggregateRoot<TId> : BaseEntity<TId>, IAggregate
{
    [JsonIgnore]
    [BsonIgnore]
    ...
    protected AggregateRoot(Guid? createdBy = null) : base(createdBy) { }

    protected AggregateRoot(TId id, Guid? createdBy = null) : base(id, createdBy) { }
