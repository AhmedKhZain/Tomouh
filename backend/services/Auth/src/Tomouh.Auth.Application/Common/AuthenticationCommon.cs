...
public static class AuthenticationCommon
{
    ...
    public static class AuthenticationErrors
    {
        ...
        // Generic External Auth Errors
        public static readonly Error InvalidExternalToken = Error.Validation(
            code: "Auth.InvalidExternalToken",
            description: "The provided external authentication token is invalid or has expired.");

        public static readonly Error ExternalAuthFailed = Error.Failure(
            code: "Auth.ExternalAuthFailed",
            description: "Failed to authenticate with external authentication provider. Please try again later.");

        public static readonly Error UnsupportedExternalProvider = Error.Validation(
            code: "Auth.UnsupportedExternalProvider",
            description: "The requested external authentication provider is not supported.");

        public static readonly Error ExternalLoginNotFound = Error.NotFound(
            code: "Auth.ExternalLoginNotFound",
            description: "No registered account was found linked to this external identity.");

        public static readonly Error ExternalLoginAlreadyLinkedToAnotherUser = Error.Conflict(
            code: "Auth.ExternalLoginAlreadyLinkedToAnotherUser",
            description: "This external account is already linked to another user.");

        public static readonly Error ExternalLoginAlreadyExists = Error.Conflict(
            code: "Auth.ExternalLoginAlreadyExists",
            description: "This external provider is already linked to your account.");

        public static readonly Error CannotRemoveLastAuthenticationMethod = Error.Conflict(
            code: "Auth.CannotRemoveLastAuthenticationMethod",
            description: "Cannot remove this login method because your account has no password and this is your only authentication method.");
    }
}